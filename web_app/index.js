...
if (demo_mode){
  ...
  messageBox.textContent = "⚠️ Demo Mode: All controls disabled, Please 'Watch the Demo Video'.";

  // Disable all buttons except the demo video link
  const buttons = document.querySelectorAll("button");
  buttons.forEach(btn => {
    if (btn.id !== "watch-demo-btn") { // add id to demo video link if needed
      btn.disabled = true;
      btn.style.opacity = "0.5"; // visually show they are disabled
